...
puppet ALL=(root) NOPASSWD: /usr/bin/journalctl -t puppet-agent --no-pager -n * --output short-iso
puppet ALL=(root) NOPASSWD: /usr/bin/journalctl -t puppet-agent --no-pager -n * --output short-iso --since *
puppet ALL=(root) NOPASSWD: /usr/bin/journalctl -t puppet --no-pager -n * --output short-iso
puppet ALL=(root) NOPASSWD: /usr/bin/journalctl -t puppet --no-pager -n * --output short-iso --since *
