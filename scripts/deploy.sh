...
for script in enc.py manage_users.py deploy.sh update_local.sh sync-openvox-repo.sh r10k-deploy.sh r10k-stage-activate.sh ensure-sudoers.sh generate_fleet_health_report.py ca-reject-csr.sh enable-console-orchestration.sh bootstrap-compiler.sh hiera-list-remote.py; do
