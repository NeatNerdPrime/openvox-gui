...
# Copy scripts
for script in enc.py manage_users.py deploy.sh r10k-deploy.sh update_local.sh sync-openvox-repo.sh generate_fleet_health_report.py ca-reject-csr.sh; do
